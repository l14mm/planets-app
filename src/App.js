...
import {
  ValidateOnlyContainsLetters, ValidateUniqueValue, ValidateUrl, ValidateIsNotNullOrEmpty,
} from './helper';
...
class App extends Component {
  ...
  componentDidUpdate(prevProps) {
    // Check if the url has changed since last time, if so,
    // then check if anything is being requested.
  ...
  selectPlanet(planetName) {
    ...
    fetch(`${apiUrl}planets/${planetName}`)
              ...
              <div>
                ...
                <div style={{ paddingTop: '20px' }}>
                  ...
                  <Button
                    ...
                    className={classes.button}
                    style={{ margin: '10px' }}
                    onClick={this.handleNewPlanetSubmit}
                  >
                    Save
                  </Button>
                </div>
